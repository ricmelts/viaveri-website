  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="pt-32 pb-16 max-w-3xl mx-auto px-6">
        <h1 className="font-display text-4xl font-bold text-ink mb-4">Terms of Service</h1>
        <p className="text-stone-500 mb-8">Last Updated: February 10, 2026</p>

        <div className="max-w-none">
          <section className="mb-8">
            <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4">1. Agreement to Terms</h2>
          ...
          <section className="mb-8">
            <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4">2. Eligibility</h2>
            <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4">3. Account Registration and Security</h2>
            <p className="text-stone-600 leading-relaxed mb-4">
              To access certain features of our Services, you may need to create an account. You agree to:
            </p>
            <ul className="list-disc pl-6 text-stone-600 leading-relaxed space-y-2 mb-4">
          ...
          <section className="mb-8">
            <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4">4. Acceptable Use</h2>
            <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4">5. User Content</h2>
            ...
            <h3 className="text-xl font-semibold text-ink mb-3 mt-6">5.2 Responsibility for Content</h3>
            <p className="text-stone-600 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-ink mb-3 mt-6">5.3 Content Monitoring</h3>
            <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4">6. Intellectual Property Rights</h2>
            <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4">7. Payment Terms</h2>

            <h3 className="text-xl font-semibold text-ink mb-3 mt-6">7.1 Fees</h3>
            <p className="text-stone-600 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-ink mb-3 mt-6">7.2 Billing</h3>
            <p className="text-stone-600 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-ink mb-3 mt-6">7.3 Price Changes</h3>
            <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4">8. Service Availability and Modifications</h2>
            <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4">9. Third-Party Services and Links</h2>
            <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4">10. Termination</h2>

            <h3 className="text-xl font-semibold text-ink mb-3 mt-6">10.1 Termination by You</h3>
            <p className="text-stone-600 leading-relaxed mb-4">
              You may terminate your account at any time by contacting us or using the account closure
              feature in your account settings.
            </p>

            <h3 className="text-xl font-semibold text-ink mb-3 mt-6">10.2 Termination by Us</h3>
            <p className="text-stone-600 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-ink mb-3 mt-6">10.3 Effect of Termination</h3>
            <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4">11. Disclaimers</h2>
            <p className="text-stone-600 leading-relaxed mb-4 uppercase font-semibold">
          ...
          <section className="mb-8">
            <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4">12. Limitation of Liability</h2>
            <p className="text-stone-600 leading-relaxed mb-4 uppercase font-semibold">
          ...
          <section className="mb-8">
            <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4">13. Indemnification</h2>
            <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4">14. Dispute Resolution</h2>

            <h3 className="text-xl font-semibold text-ink mb-3 mt-6">14.1 Informal Resolution</h3>
            <p className="text-stone-600 leading-relaxed mb-4">
              Before filing a formal claim, you agree to contact us and attempt to resolve any dispute informally.
              Contact us at <a href="mailto:legal@viaveri.co" className="text-ink underline hover:text-stone-600">legal@viaveri.co</a> to
              initiate the informal dispute resolution process.
            </p>

            <h3 className="text-xl font-semibold text-ink mb-3 mt-6">14.2 Arbitration</h3>
            <p className="text-stone-600 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-ink mb-3 mt-6">14.3 Class Action Waiver</h3>
            <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4">15. Governing Law and Jurisdiction</h2>
            <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4">16. Changes to These Terms</h2>
            <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4">17. General Provisions</h2>

            <h3 className="text-xl font-semibold text-ink mb-3 mt-6">17.1 Entire Agreement</h3>
            <p className="text-stone-600 leading-relaxed mb-4">
              These Terms, together with our Privacy Policy, constitute the entire agreement between you and
              ViaVeri regarding the Services and supersede all prior agreements.
            </p>

            <h3 className="text-xl font-semibold text-ink mb-3 mt-6">17.2 Severability</h3>
            <p className="text-stone-600 leading-relaxed mb-4">
              If any provision of these Terms is found to be invalid or unenforceable, the remaining provisions
              will remain in full force and effect.
            </p>

            <h3 className="text-xl font-semibold text-ink mb-3 mt-6">17.3 Waiver</h3>
            <p className="text-stone-600 leading-relaxed mb-4">
              Our failure to enforce any right or provision of these Terms will not be deemed a waiver of such
              right or provision.
            </p>

            <h3 className="text-xl font-semibold text-ink mb-3 mt-6">17.4 Assignment</h3>
            <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4">18. Contact Information</h2>
            <p className="text-stone-600 leading-relaxed mb-4">
              If you have any questions about these Terms, please contact us:
            </p>
            <div className="bg-stone-50 border border-stone-200 p-6 rounded-lg">
              <p className="text-ink font-semibold mb-2">ViaVeri</p>
              <p className="text-stone-600">Legal Inquiries: <a href="mailto:legal@viaveri.co" className="text-ink underline hover:text-stone-600">legal@viaveri.co</a></p>
              <p className="text-stone-600">General Inquiries: <a href="mailto:info@viaveri.co" className="text-ink underline hover:text-stone-600">info@viaveri.co</a></p>
            </div>
          </section>
        </div>
      </div>
