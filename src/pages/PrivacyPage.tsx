  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="pt-32 pb-16 max-w-3xl mx-auto px-6">
        <h1 className="font-display text-4xl font-bold text-ink mb-4">Privacy Policy</h1>
        <p className="text-stone-500 mb-8">Last Updated: February 10, 2026</p>

        <div className="max-w-none">
          <section className="mb-8">
            <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4">Introduction</h2>
          ...
          <section className="mb-8">
            <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4">1. Information We Collect</h2>

            <h3 className="text-xl font-semibold text-ink mb-3 mt-6">1.1 Personal Information You Provide</h3>
            <p className="text-stone-600 leading-relaxed mb-3">We collect information that you voluntarily provide to us, including:</p>
            ...
            <h3 className="text-xl font-semibold text-ink mb-3 mt-6">1.2 Information Collected Automatically</h3>
            <p className="text-stone-600 leading-relaxed mb-3">When you access our services, we automatically collect:</p>
            <ul className="list-disc pl-6 text-stone-600 leading-relaxed space-y-2 mb-4">
            ...
            <h3 className="text-xl font-semibold text-ink mb-3 mt-6">1.3 Information from Third Parties</h3>
            <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4">2. How We Use Your Information</h2>
          ...
          <section className="mb-8">
            <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4">3. How We Share Your Information</h2>
            <p className="text-stone-600 leading-relaxed mb-3">We may share your information in the following circumstances:</p>
            <ul className="list-disc pl-6 text-stone-600 leading-relaxed space-y-2 mb-4">
          ...
          <section className="mb-8">
            <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4">4. Data Retention</h2>
            <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4">5. Data Security</h2>
            <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4">6. Your Rights and Choices</h2>
            <p className="text-stone-600 leading-relaxed mb-3">Depending on your location, you may have the following rights:</p>
            <ul className="list-disc pl-6 text-stone-600 leading-relaxed space-y-2 mb-4">
            ...
            <p className="text-stone-600 leading-relaxed mb-4">
              To exercise these rights, please contact us at <a href="mailto:privacy@viaveri.co" className="text-ink underline hover:text-stone-600">privacy@viaveri.co</a>.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4">7. Cookies and Tracking Technologies</h2>
            <p className="text-stone-600 leading-relaxed mb-4">
            ...
            <p className="text-stone-600 leading-relaxed mb-3">We use the following types of cookies:</p>
            <ul className="list-disc pl-6 text-stone-600 leading-relaxed space-y-2 mb-4">
          ...
          <section className="mb-8">
            <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4">8. Third-Party Links and Services</h2>
            <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4">9. Children's Privacy</h2>
            <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4">10. International Data Transfers</h2>
            <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4">11. Changes to This Privacy Policy</h2>
            <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4">12. Contact Us</h2>
            <p className="text-stone-600 leading-relaxed mb-4">
            ...
            <div className="bg-stone-50 border border-stone-200 p-6 rounded-lg">
              ...
              <p className="text-stone-600">Email: <a href="mailto:privacy@viaveri.co" className="text-ink underline hover:text-stone-600">privacy@viaveri.co</a></p>
